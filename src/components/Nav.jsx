...
const Nav = () => {
  ...
  return (
    <header className="bg-black py-4 shadow-lg shadow-yellow-400">
      <div className="flex justify-between items-center container mx-5"> 
        {/* Company Logo */}
        <div className="flex items-center">
          ...
          />
          <h1 className="text-white text-3xl font-bold rounded-full px-2 transition-transform duration-300 hover:scale-110 hover:shadow-lg hover:shadow-white">
